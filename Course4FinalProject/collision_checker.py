    ...
    def collision_check(self, paths, obstacles):
        ...
        for i in range(len(paths)):
            ...
            for j in range(len(path[0])):
                ...
                # --------------------------------------------------------------
                for z in range(len(self._circle_offsets)):
                    circle_locations[z, 0] = path[0][j] + self._circle_offsets[z]*int(cos(path[2][j])) 
                    circle_locations[z, 1] = path[1][j] + self._circle_offsets[z]*int(sin(path[2][j]))
                # --------------------------------------------------------------
